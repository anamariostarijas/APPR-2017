...
```{r razpredelnice}
kable(head(drzavna.poraba.delez.BDP))
head(drzavna.poraba.delez.BDP)
```
...
```{r zemljevid, echo=FALSE, fig.align='center', fig.cap='Zemljevid potrošnje evropskih držav za izobrazbo v odstotkih BDP-ja'}
...
Za prvi graf sem izmed vseh izvzela le 6 držav, 3 z najvišjo potrošnjo in 3 z najnižjo. Te sem poiskala tako, da sem seštela potrošnjo od leta 2004 naprej za vsako državo posebej in poiskala države v najvišjih desetih odstotkih ter najnižjih. Izpustila sem prejšnja leta, ker je mnogo podatkov manjkalo in bi ti motili rezultate. Tako je graf lažje berljiv in nam pokaže bistvene podatke.
...
Zanima me, če obstaja kakšna povezava med potrošnjo za izobrazbo in rastjo BDP-ja, zato sem si ogledala še graf rasti BDP-ja za teh 6 držav. Seveda je BDP med krizo padel, ampak iz tega še ne morem sklepati o povezavi.
