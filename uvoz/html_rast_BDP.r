...
for (col in colnames(html.rast.BDP2)[-1]) {
...
html.rast.BDP2$drzava <- gsub("^Germany.*$","Germany",html.rast.BDP2$drzava)
html.rast.BDP2$drzava <- gsub("^Czech.*$","Czech Rep.",html.rast.BDP2$drzava)
